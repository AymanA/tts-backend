...
abstract class BaseRepository implements BaseRepositoryInterface {
	...
	/**
	 * updateOrCreate a new model record in the database
	 *
	 * @param array $data, array $newData
	 *
	...
	{
		$this->unsetClauses();
		return $this->model->updateOrCreate($data,$newData);
	}
	...
	/**
	 * Create a new models records in the database
	 *
	 * @param array $data
	 *
	 * @return \Illuminate\Database\Eloquent\Model
	...
	{
		return $this->model->insertOrIgnore($array);
	}
